    ...
    <div class="container pt-5 pb-5" style="margin-top : 5rem;">
        <div class="row justify-content-md-center ">
            ...
            <div class="card shadow sm-3 mb-5 bg-white rounded">
                <div class="card-header bg-primary mb-0"><h5 class="text-center text-white">Tambah Data <span class="font-weight-bold text-light " >Pendidikan</span></h5></div>
                <div class="card-body">
                <?php
                include("../../koneksi.php");
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pendidikan" class="form-control" placeholder="Masukkan Pendidikan Anda">
                    </div>
                    <div class="form-group">
