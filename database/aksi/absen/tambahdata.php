...
<body>
    ...
    <!-- mengisi data -->
    <div class="container pt-5 pb-5" style="margin-top : 10rem;">
            ...
            <div class="card shadow sm-3 mb-5 bg-white rounded">
                ...
                if(isset($_POST['tambah'])){
                  ...
                  if($data->num_rows > 0){
                    ...
                    echo '<script>alert("Berhasil menambah data."); document.location="../../absen.php";</script>';
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="NIK" class="form-control" placeholder="Masukkan Nama Lengkap Anda">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <a href="../../absen.php" class="btn btn-danger btn-block active" role="button" aria-pressed="true">Batal</a>
                    </div>
                </form>
                </div>
            </div>
