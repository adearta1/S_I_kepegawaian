    ...
    <div class="container pt-5 pb-5" style="margin-top : 4rem;">
        <div class="row justify-content-md-center ">
            ...
            <div class="card shadow sm-3 mb-5 bg-white rounded">
                <div class="card-header bg-primary mb-0"><h5 class="text-center text-white">Edit Data <span class="font-weight-bold text-light " >Izin Karyawan</span></h5></div>
                <div class="card-body">
                <?php
                    ...
                    $da = mysqli_query($koneksi,"SELECT * FROM izin WHERE id_izin='$ubah'");
                    if (isset($_POST['edit'])) {
                        $id = $_POST['id_izin'];
                        $NIK = $_POST['NIK'];
                        ...
                        if($data->num_rows > 0){
                          $query="UPDATE izin SET id_izin = '$id', NIK='$NIK',keterangan='$keterangan',izin_tanggal='$izin_tanggal', sampai_tanggal='$sampai_tanggal', update_at='$update_at' WHERE id_izin='$id'";
                          mysqli_query($koneksi,$query) or die ('gagal');
                          echo '<script>alert("Berhasil mengedit data."); document.location="../../izin.php";</script>';
                        } else {
                        ?>
                        <div class="alert alert-primary text-center text-danger" role="alert">
                            gagal mengapdate data izin
                        </div> 
                        <?php } 
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_izin" class="form-control" value="<?php echo $dat['id_izin']; ?>">
                        <input type="text" name="NIK" class="form-control" value="<?php echo $dat['NIK']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Keterangan</label>
                        <textarea name="keterangan" class="form-control" id="exampleFormControlTextarea1" rows="3" ><?php echo $dat['keterangan']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Izin Dari Tanggal</label>
                        <input type="date" name="izin_tanggal" class="form-control" value="<?php echo $dat['izin_tanggal']; ?>">
                        <label for="exampleFormControlSelect1">Izin Sampai Tanggal</label>
                        <input type="date" name="sampai_tanggal" class="form-control" value="<?php echo $dat['sampai_tanggal']; ?>">
                    </div>
                    <div class="form-group">
